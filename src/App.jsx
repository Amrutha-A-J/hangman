...
const countries = [
	...
	"Botswana", "Brazil", "Brunei", "Bulgaria", "Burkina", "Burundi", "Cambodia", "Cameroon", "Canada", "Cape Verde", "Chad", "Chile",
	...
	"Paraguay", "Peru", "Philippines", "Poland", "Portugal", "Qatar", "Romania", "Russian Federation", "Rwanda", "St Lucia", "Samoa",
...
function App() {
	...
	const startNewGame = () => {
		...
		setGameOver(false);
		setGameWon(false);
		setOverlayVisible(false); // Hide overlay when starting a new game
	};
	...
	useEffect(() => {
		if (gameOver && !gameWon) {
			const timer = setTimeout(() => {
				setOverlayVisible(true); // Show overlay after delay
			}, 1000); 
	...
	const shouldShowOverlay = overlayVisible || gameWon;
